...
1. Run `cadl init https://raw.githubusercontent.com/Azure/cadl-azure-resource-manager/main/scaffolding.json` in a new folder
...
```json
{
  ...
  "dependencies": {
    ...
    "@azure-tools/cadl-azure-resource-manager": "latest"
  },
  "devDependencies": {}
}
```
