...
namespace Microsoft.ContosoProviderHub.Service
{
    ...
    public abstract class EmployeeControllerBase : ControllerBase
    {
        ...
        [HttpPost]
        [Route(ContosoProviderHubServiceRoutes.EmployeeValidateRead)]
        ...
        [HttpPost]
        [Route(ContosoProviderHubServiceRoutes.EmployeeBeginRead)]
        ...
        [HttpPost]
        [Route(ContosoProviderHubServiceRoutes.EmployeeValidateCreate)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(ValidationResponse))]
        ...
        [HttpPost]
        [Route(ContosoProviderHubServiceRoutes.EmployeeEndCreate)]
        ...
        /// <returns> The Employee resource.</returns>
        [HttpPut]
        [Route(ContosoProviderHubServiceRoutes.EmployeeItem)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(Employee))]
        ...
        [HttpPost]
        [Route(ContosoProviderHubServiceRoutes.EmployeeValidatePatch)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(ValidationResponse))]
        ...
        /// <returns> Nothing.</returns>
        [HttpPost]
        [Route(ContosoProviderHubServiceRoutes.EmployeeEndPatch)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(void))]
        ...
        [HttpPost]
        [Route(ContosoProviderHubServiceRoutes.EmployeeValidateDelete)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(ValidationResponse))]
        ...
        /// <returns> Nothing.</returns>
        [HttpPost]
        [Route(ContosoProviderHubServiceRoutes.EmployeeEndDelete)]
        [ProducesResponseType((int)HttpStatusCode.OK, Type = typeof(void))]
