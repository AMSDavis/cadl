...
namespace Microsoft.ContosoRPaas.Service
{
    public abstract class OperationControllerBase : Controller
    {
        ...
        /// <summary>
        /// List all operations provided by Microsoft.ContosoRPaas.
        /// </summary>
        /// <returns> The list of Microsoft.ContosoRPaas operations.</returns>
        [HttpGet]
        [Route(ContosoRPaasServiceRoutes.ListOperations)]
